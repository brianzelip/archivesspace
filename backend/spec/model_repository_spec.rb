...
describe 'Repository model' do
  ...
  it 'enforces ID uniqueness' do
    expect {
      Repository.create_from_json(JSONModel(:repository).from_hash(repo_code: 'TESTREPO',
                                                                   name: 'My new test repository'))
    } .not_to raise_error
