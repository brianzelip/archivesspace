...
class ASFopExternal
  ...
  def initialize(source, job, pdf_image)
    ...
    @pdf_image = if pdf_image.nil?
                   'file:///' + File.absolute_path(StaticAssetFinder.new(File.join('stylesheets')).find('archivesspace.small.png'))
                 else
                   pdf_image
                 end
  ...
  def path_to_fop_jar
    ...
    if File.exist?('../../../../../lib/fop.jar')
      '../../../../../lib'
    elsif File.exist?('../common/lib/fop.jar')
      '../common/lib'
    elsif File.exist?('../lib/fop.jar')
      '../lib'
    elsif File.exist?('../../lib/fop.jar')
      '../../lib'
    elsif File.exist?('../../../lib/fop.jar')
