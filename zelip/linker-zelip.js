    ...
    $(this).each(function() {
      ...
      function tokenName(object) {
        ...
        if (object.four_part_id !== undefined) {
          ...
          if (fourPartId.length > 0) {
            return fourPartId.join(' ') + ': ' + title;
          } else {
            return title;
          };
        }
      ...
      function tokenNameFromJSON(object) {
        console.log('JSON data:::', object);
        var title = (object.display_string || object.title);
        var idProperties = ['id_0', 'id_1', 'id_2', 'id_3'];
        var fourPartId = idProperties
