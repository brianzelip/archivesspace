class SearchController < ApplicationController
  ...
  DEFAULT_SEARCH_FACET_TYPES = ['repository', 'primary_type', 'subjects', 'published_agents'].freeze
  DEFAULT_SEARCH_OPTS = {
    #    'sort' => 'title_sort asc',
    'resolve[]' => ['repository:id', 'resource:id@compact_resource', 'ancestors:id@compact_resource', 'top_container_uri_u_sstr:id'],
    'facet.mincount' => 1
  }.freeze
  DEFAULT_TYPES = ['archival_object', 'digital_object', 'agent', 'resource', 'repository', 'accession', 'classification', 'subject'].freeze
