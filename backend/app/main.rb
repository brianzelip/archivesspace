...
Rack::Utils.key_space_limit = 655_360 # x10 Rack default
  ...
  configure do
    begin
      ...
      if ASpaceEnvironment.environment == :production
        ...
        unless settings.respond_to? :scheduler?
...
if $0 == __FILE__
  ...
  ArchivesSpaceService.run!(bind: '0.0.0.0', port: (ARGV[0] || 4567)) do |server|
    def server.stop
