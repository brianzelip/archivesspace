...
Sequel.migration do
  up do
    ...
    if update_archival_record_permission_id
      warn('Adding separate permissions for updating major record types')
      ...
      if manage_vocabulary_permission_id.nil?
        warn('    ... managing vocabulary records')
      ...
      warn('Updating groups to include the new permssions')
      ...
      warn('Deleting update_archival_record permission')
