    ...
    describe 'slug autogen enabled' do
      describe 'by name' do
        ...
        it 'autogenerates a slug via title' do
          digital_object_component = DigitalObjectComponent.create_from_json(build(:json_digital_object_component, is_slug_auto: true, title: rand(100_000).to_s))
