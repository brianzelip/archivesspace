...
describe 'indexer common config' do
  ...
  describe 'resolved_attributes' do
    ...
    it 'has the correct resolved_attributes' do
      attrs = ['location_profile', 'container_profile', 'container_locations', 'subjects', 'linked_agents', 'linked_records', 'classifications', 'digital_object', 'agent_representation', 'repository', 'repository::agent_representation', 'related_agents', 'top_container', 'top_container::container_profile', 'related_agents', 'records', 'collections', 'surveyed_by', 'reviewer']
