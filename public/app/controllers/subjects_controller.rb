class SubjectsController < ApplicationController
  ...
  DEFAULT_SUBJ_TYPES = ['repository', 'resource', 'accession', 'archival_object', 'digital_object'].freeze
  DEFAULT_SUBJ_FACET_TYPES = ['primary_type', 'published_agents', 'used_within_published_repository'].freeze
  ...
  def index
    ...
    begin
      ...
      redirect_back(fallback_location: '/subjects') && return
    end
  ...
  def search
    ...
    @sort_opts = []
    ['relevance', 'title_sort_asc', 'title_sort_desc'].each do |type|
      @sort_opts.push(all_sorts[type])
    end
    @no_statement = true
    render 'search/search_results'
