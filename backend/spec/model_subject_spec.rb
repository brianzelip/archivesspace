    ...
    describe 'slug autogen enabled' do
      describe 'by name' do
        ...
        it 'autogenerates a slug via title' do
          subject = Subject.create_from_json(build(:json_subject, is_slug_auto: true, title: rand(100_000).to_s))
      ...
      describe 'by id' do
        ...
        it 'autogenerates a slug via identifier' do
          subject = Subject.create_from_json(build(:json_subject, is_slug_auto: true, authority_id: rand(100_000).to_s))
