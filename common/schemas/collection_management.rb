{
  schema: {
    ...
    'properties' => {
      ...
      'processing_plan' => { 'type' => 'string', 'maxLength' => 65_000, 'required' => false },
      'processing_priority' => { 'type' => 'string', 'required' => false, 'dynamic_enum' => 'collection_management_processing_priority' },
      'processing_funding_source' => { 'type' => 'string', 'maxLength' => 65_000, 'required' => false },
      'processors' => { 'type' => 'string', 'maxLength' => 65_000, 'required' => false },
