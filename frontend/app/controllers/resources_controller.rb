class ResourcesController < ApplicationController
  ...
  def edit
    ...
    if params[:inline]
      ...
      return redirect_to(action: :show, id: params[:id], inline: params[:inline]) if @resource.suppressed
  ...
  def add_children
    ...
    if params[:archival_record_children].blank? || params[:archival_record_children]['children'].blank?
