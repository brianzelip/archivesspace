  ...
  def self.apply_definitions(repo_id, json)
    ...
    DB.open do |db|
      ...
      begin
        ...
        raise ConflictException, 'RECORD_IN_USE'
      end
      ...
      definitions.each do |d|
        ...
        raise ConflictException, conflicting_labels.map { |row| row[:label] } unless conflicting_labels.empty?
        ...
        raise ConflictException, conflicting_repo_labels.map { |row| row[:label] } unless conflicting_repo_labels.empty?
      end
