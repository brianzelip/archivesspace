    ...
    describe 'slug autogen enabled' do
      describe 'by name' do
        ...
        it 'autogenerates a slug via title' do
          resource = Resource.create_from_json(build(:json_resource, is_slug_auto: true, title: rand(100_000).to_s))
      ...
      describe 'by eadid' do
        ...
        it 'autogenerates a slug via eadid when configured to generate by eadid' do
          resource = Resource.create_from_json(build(:json_resource, is_slug_auto: true, ead_id: rand(100_000).to_s))
