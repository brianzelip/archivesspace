{
  schema: {
    ...
    'properties' => {
      ...
      'content_description' => { 'type' => 'string', 'maxLength' => 65_000 },
      'condition_description' => { 'type' => 'string', 'maxLength' => 65_000 },

      'disposition' => { 'type' => 'string', 'maxLength' => 65_000 },
      'inventory' => { 'type' => 'string', 'maxLength' => 65_000 },

      'provenance' => { 'type' => 'string', 'maxLength' => 65_000 },
      ...
      'retention_rule' => { 'type' => 'string', 'maxLength' => 65_000 },

      'general_note' => { 'type' => 'string', 'maxLength' => 65_000 },

      'access_restrictions' => { 'type' => 'boolean', 'default' => false },
      'access_restrictions_note' => { 'type' => 'string', 'maxLength' => 65_000 },

      'use_restrictions' => { 'type' => 'boolean', 'default' => false },
      'use_restrictions_note' => { 'type' => 'string', 'maxLength' => 65_000 },
