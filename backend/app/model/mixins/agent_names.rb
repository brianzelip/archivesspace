module AgentNames
  ...
  def before_validation
    ...
    # desired.
    self.authorized = nil if authorized != 1
    self.is_display_name = nil if is_display_name != 1
  end
  ...
  module ClassMethods
    ...
    def sequel_to_jsonmodel(objs, opts = {})
      ...
      jsons.zip(objs).each do |json, obj|
        json['authority_id'] = obj.name_authority_id.authority_id if obj.name_authority_id
      end
    ...
    def assemble_hash_fields(json)
      ...
      hash_fields = []
      name_fields = ['dates', 'qualifier', 'source', 'rules'] + type_specific_hash_fields
