    ...
    describe 'slug autogen enabled' do
      describe 'by name' do
        ...
        it 'autogenerates a slug via title' do
          classification_term = ClassificationTerm.create_from_json(build(:json_classification_term, is_slug_auto: true, title: rand(100_000).to_s))
