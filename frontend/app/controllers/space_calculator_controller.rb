class SpaceCalculatorController < ApplicationController
  ...
  def show
    ...
    @container_profile = JSONModel(:container_profile).find_by_uri(@container_profile_ref) unless @container_profile_ref.blank?
  ...
  def calculate
    @container_profile_ref = params[:container_profile][:ref] if params[:container_profile]
