    ...
    describe 'slug autogen enabled' do
      describe 'by name' do
        ...
        it 'autogenerates a slug via title' do
          archival_object = ArchivalObject.create_from_json(build(:json_archival_object, is_slug_auto: true, title: rand(100_000).to_s))
      ...
      describe 'by id' do
        ...
        it 'autogenerates a slug via identifier' do
          archival_object = ArchivalObject.create_from_json(build(:json_archival_object, is_slug_auto: true, ref_id: 'foo' + rand(10_000).to_s))
      ...
      describe 'by cuid' do
        ...
        it 'autogenerates a slug via cuid' do
          archival_object = ArchivalObject.create_from_json(build(:json_archival_object, is_slug_auto: true, component_id: rand(100_000).to_s))
