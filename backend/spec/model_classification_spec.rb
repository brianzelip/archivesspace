    ...
    describe 'slug autogen enabled' do
      describe 'by name' do
        ...
        it 'autogenerates a slug via title' do
          classification = Classification.create_from_json(build(:json_classification, is_slug_auto: true, title: rand(100_000).to_s))
