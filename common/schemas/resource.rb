...

{
  schema: {
    ...
    'properties' => {
      ...
      'repository_processing_note' => { 'type' => 'string', 'maxLength' => 65_000 },

      'ead_id' => { 'type' => 'string', 'maxLength' => 255 },
      'ead_location' => { 'type' => 'string', 'maxLength' => 255 },

      # Finding aid
      'finding_aid_title' => { 'type' => 'string', 'maxLength' => 65_000 },
      'finding_aid_subtitle' => { 'type' => 'string', 'maxLength' => 65_000 },
      'finding_aid_filing_title' => { 'type' => 'string', 'maxLength' => 65_000 },
      'finding_aid_date' => { 'type' => 'string', 'maxLength' => 255 },
      'finding_aid_author' => { 'type' => 'string', 'maxLength' => 65_000 },
      ...
      'finding_aid_language_note' => { 'type' => 'string', 'maxLength' => 65_000 },
      'finding_aid_sponsor' => { 'type' => 'string', 'maxLength' => 65_000 },
      'finding_aid_edition_statement' => { 'type' => 'string', 'maxLength' => 65_000 },
      'finding_aid_series_statement' => { 'type' => 'string', 'maxLength' => 65_000 },
      'finding_aid_status' => { 'type' => 'string', 'dynamic_enum' => 'resource_finding_aid_status' },
      'finding_aid_note' => { 'type' => 'string', 'maxLength' => 65_000 },
