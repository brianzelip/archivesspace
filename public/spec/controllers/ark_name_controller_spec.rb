...
class ArkQueryResponseMock
  ...
  def body
    { id: @id, type: @type, repo_id: @repo_id, external_url: @external_url }.to_json
  end
end
...
describe ArkNameController, type: :controller do
  it 'should redirect to the correct URL for a resource' do
    ...
    expect(response.location).to match(%r{/repositories/5/resources/4})
  end
  ...
  it 'should redirect to the correct URL for an archival object' do
    ...
    expect(response.location).to match(%r{/repositories/5/archival_objects/4})
  end
